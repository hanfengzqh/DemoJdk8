...
public class CoordinateConvert {
    ...
    /**
     * 84(地球坐标) to 火星坐标系 (GCJ-02) World Geodetic System ==> Mars Geodetic System
     *
     * @param lat 纬度
     * @param lon 经度
     * @return
    ...
    /**
     * * 火星坐标系 (GCJ-02) to 84(地球坐标) * * @param lon * @param lat * @return
     */
    ...
    public static Gps bd09_To_gps84(double lat, double lon) {
        ...
        Gps gps84 = gcj02_To_Gps84(gcj02.getWgLat(), gcj02.getWgLon());
        // 保留小数点后六位
        double tempLat = retain6(gps84.getWgLat());
        double tempLon = retain6(gps84.getWgLon());
        return new Gps(tempLat, tempLon);
    }
    ...
    /**
     * @param lat 纬度  39.982019
     * @param lon 经度  116.309298
     * @return true 国外;false 中国境内
     */
